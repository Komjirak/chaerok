        ...
        <div className="space-y-12">
          ...
          <article>
            ...
            <p className="text-ink-muted leading-relaxed mb-4">
              {isEn
                ? "Paid subscriptions, such as Chaerok Mind, are subject to the payment policies of the app market (App Store / Google Play) where the user subscribed."
                : "채록 Mind 등 유료 구독은 이용자가 가입한 앱 마켓(App Store / Google Play)의 결제 정책을 따릅니다."
              }
            </p>
